...
4. Database bağlantısı için migration eklemelisiniz.  `add-migration "CreateDb` ->  `update-database` komutlarınını çalıştırın.
5. Tarayıcıdan `http://localhost:5000` adresine giderek API'ye erişim sağlayabilirsiniz.
